...
class MyClockWidget(FloatLayout):
    ...
    def update_clock(self, *args):
        ...
        minutes_hand = self.position_on_clock(time.minute / 60 + time.second / 3600, length=0.4*hands.size[0])
